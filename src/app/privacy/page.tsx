...
export default function Privacy() {
    ...
    return (
        <div className="max-w-4xl mx-auto py-12 px-4 italic-not-really">
            <div className="glass-card p-8 md:p-12 space-y-8 text-gray-700">
                <header className="text-center border-b border-gray-100 pb-8 mb-8">
                    ...
                    <p className="text-sm text-gray-500">최종 수정일: {lastUpdated}</p>
                </header>

                <section className="space-y-4">
                    <h3 className="text-xl font-bold text-gray-800">1. 개인정보의 수집 및 이용 목적</h3>
                ...
                <section className="space-y-4">
                    <h3 className="text-xl font-bold text-gray-800">2. 수집하는 개인정보 항목</h3>
                    <p className="leading-relaxed">
                ...
                <section className="space-y-4">
                    <h3 className="text-xl font-bold text-gray-800">3. 개인정보의 보유 및 이용 기간</h3>
                    <p className="leading-relaxed">
                ...
                <section className="space-y-4">
                    <h3 className="text-xl font-bold text-gray-800">4. 제3자 제공 및 위탁</h3>
                    <p className="leading-relaxed">
                ...
                <section className="space-y-4">
                    <h3 className="text-xl font-bold text-gray-800">5. 정보주체의 권리</h3>
                    <p className="leading-relaxed">
                ...
                <footer className="pt-8 border-top border-gray-100 mt-12 text-sm text-gray-500 text-center">
